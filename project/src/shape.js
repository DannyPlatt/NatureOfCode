	...
	constructor(name, material) {
		...
		this.promise = fetch("../" + name)
			...
			.then((text) => {
				...
				console.log("Max index in triangles:", Math.max(...this.triangles.flat()));
				console.log("Flattened vertex array length:", this.vertices.flat().length);
				console.log("Flattened triangles array length:", this.triangles.flat().length);
