...
function checkKeys(state, keysPressed){
  ...
  if(keysPressed['a']){
    mat4.rotateY(state.objects[0].model.rotation.mat, state.objects[0].model.rotation.mat, state.player.rotateVel);
    vec3.rotateY(state.objects[0].model.lookat, state.objects[0].model.lookat, [0, 0, 0], state.player.rotateVel);
  }
