...
class Particle{
  constructor(x,y) {
    ...
    this.velocity.x = random(-0.05, 0.05); // give an initial upwards velocity
    this.velocity.y = random(-.1, 0); // give an initial upwards velocity
    this.acceleration = createVector(0,0);
    this.radius = .1 * pxPerCm;
    this.mass = 10;
    this.lifeTime = .3;
    this.elapsedTime = 0;
    this.color = [200, y, 250];
    // angular Motion
    this.angle = 0;
  ...
  run() {
    ...
    let gravity = createVector(0, 9.81);
